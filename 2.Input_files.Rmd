...
`PHRAPL` requires two types of input files: one assignment file (cladeAssignments.txt) and one file with all phylogenetic trees in newik format (trees.tre). The trees file must have one tree per gene or independent marker. __All files (assignment and trees file) must have the same taxon names (labels) for individuals across all loci.__

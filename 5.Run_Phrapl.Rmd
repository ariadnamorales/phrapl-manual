...
# Number of populations that were subsampled per populations
popAssignments<-list(c(2, 2, 2)),

# Total number of individuals per populations (listed in your assignement file)
...
**WARNING**
Need to add notes on `msPath` and `comparePath`
